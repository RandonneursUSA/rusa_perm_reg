 ...
 */
interface RusaPermRegistrationInterface extends ContentEntityInterface, EntityOwnerInterface, EntityChangedInterface {
   ...
   *
   * @return \Drupal\rusa_perm_reg\RusaPermRegistrationInterface
